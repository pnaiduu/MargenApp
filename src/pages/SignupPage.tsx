    ...
    <div className="flex min-h-dvh flex-col bg-[var(--color-margen-surface)]">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-1 text-center text-2xl font-semibold text-[var(--color-margen-text)]">Create your business account</h1>
          <p className="mt-2 text-sm text-[var(--color-margen-muted)]">
            For home service business owners. Technicians join via the Margen mobile app.
          </p>
          {planHint ? (
